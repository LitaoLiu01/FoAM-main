...
def main(args):
    ...
    if task_name == "sim_put_black_stapler_to_locker_middle_layer":
        dataset_dir = 'data/PutBlackStaplerToLockerMiddleLayer/'
    elif task_name == "sim_put_blue_block_to_locker_middle_layer":
        dataset_dir = 'data/PutBlueBlockToLockerMiddleLayer/'

    elif task_name == "sim_put_black_stapler_to_locker_bottom_layer":
        dataset_dir = 'data/PutBlackStaplerToLockerBottomLayer/'
    elif task_name == "sim_put_blue_block_to_locker_bottom_layer":
        dataset_dir = 'data/PutBlueBlockToLockerBottomLayer/'
