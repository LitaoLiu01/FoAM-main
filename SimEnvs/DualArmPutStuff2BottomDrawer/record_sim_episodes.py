...
def main(args):
    ...
    if task_name == "sim_put_apple_to_bottom_drawer":
        dataset_dir = 'data/PutAppleToBottomDrawer/'
    elif task_name == "sim_put_banana_to_bottom_drawer":
        dataset_dir = 'data/PutBananaToBottomDrawer/'
    elif task_name == "sim_put_green_bottle_to_bottom_drawer":
        dataset_dir = 'data/PutGreenBottleToBottomDrawer/'
    elif task_name == "sim_put_blue_bottle_to_bottom_drawer":
        dataset_dir = 'data/PutBlueBottleToBottomDrawer/'
    else:
        NotImplementedError
    num_episodes = 50
