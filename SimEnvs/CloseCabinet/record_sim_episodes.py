...
def main(args):
    ...
    if task_name == "sim_close_cabinet_top_drawer":
        dataset_dir = 'data/CloseTopDrawer/'
    if task_name == "sim_close_cabinet_middle_drawer":
        dataset_dir = 'data/CloseMiddleDrawer/'
    if task_name == "sim_close_cabinet_bottom_drawer":
        dataset_dir = 'data/CloseBottomDrawer/'
    num_episodes = 50
