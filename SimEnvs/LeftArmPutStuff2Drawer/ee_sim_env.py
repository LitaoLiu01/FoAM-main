...
from utils import sample_box_pose, SampleRightBoxCenterPosition, SapleCabinetPose
...
class TransferTask(BimanualViperXEETask):
    ...
    def initialize_episode(self, physics):
        ...
        print('cabinet_state', AllStuffPose)
        physics.data.qpos[cabinet_body_id:cabinet_body_id + 38] = AllStuffPose
        super().initialize_episode(physics)
