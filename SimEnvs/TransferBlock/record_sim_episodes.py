...
def main(args):
    ...
    if task_name == "sim_transfer_right_red_block_to_left":
        dataset_dir = 'data/TransferRightRedBlockToLeft/'
    elif task_name == "sim_transfer_right_yellow_block_to_left":
        dataset_dir = 'data/TransferRightYellowBlockToLeft/'
    elif task_name == "sim_transfer_right_blue_block_to_left":
        dataset_dir = 'data/TransferRightBlueBlockToLeft/'
    elif task_name == "sim_transfer_right_green_block_to_left":
        dataset_dir = 'data/TransferRightGreenBlockToLeft/'

    elif task_name == "sim_transfer_left_red_block_to_right":
        dataset_dir = 'data/TransferLeftRedBlockToRight/'
    elif task_name == "sim_transfer_left_yellow_block_to_right":
        dataset_dir = 'data/TransferLeftYellowBlockToRight/'
    elif task_name == "sim_transfer_left_blue_block_to_right":
        dataset_dir = 'data/TransferLeftBlueBlockToRight/'
    elif task_name == "sim_transfer_left_green_block_to_right":
        dataset_dir = 'data/TransferLeftGreenBlockToRight/'
