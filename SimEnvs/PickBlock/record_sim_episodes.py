...
def main(args):
    ...
    if task_name == "sim_pick_the_right_red_block":
        dataset_dir = 'data/PickRightRedBlock/'
    if task_name == "sim_pick_the_right_yellow_block":
        dataset_dir = 'data/PickRightYellowBlock/'
    if task_name == "sim_pick_the_right_blue_block":
        dataset_dir = 'data/PickRightBlueBlock/'
    if task_name == "sim_pick_the_right_green_block":
        dataset_dir = 'data/PickRightGreenBlock/'
    if task_name == "sim_pick_the_left_red_block":
        dataset_dir = 'data/PickLeftRedBlock/'
    if task_name == "sim_pick_the_left_yellow_block":
        dataset_dir = 'data/PickLeftYellowBlock/'
    if task_name == "sim_pick_the_left_blue_block":
        dataset_dir = 'data/PickLeftBlueBlock/'
    if task_name == "sim_pick_the_left_green_block":
        dataset_dir = 'data/PickLeftGreenBlock/'
    num_episodes = 50
