...
class PickAndTransferPolicy(BasePolicy):
    def generate_trajectory(self, ts_first):
        ...
        config = self.config
        if config['task_name'] == 'sim_pick_the_right_red_block':
        ...
        elif config['task_name'] == 'sim_pick_the_right_yellow_block':
            gripper_pick_quat = Quaternion(init_mocap_pose_right[3:])
            gripper_pick_quat = gripper_pick_quat * Quaternion(axis=[.0, 1.0, .0], degrees=180)
            self.right_trajectory = [
                {"t": 0, "xyz": init_mocap_pose_right[:3], "quat": init_mocap_pose_right[3:], "gripper": 80}, # sleep
        ...
        elif config['task_name'] == 'sim_pick_the_right_blue_block':
            gripper_pick_quat = Quaternion(init_mocap_pose_right[3:])
            gripper_pick_quat = gripper_pick_quat * Quaternion(axis=[.0, 1.0, .0], degrees=180)
            self.right_trajectory = [
                {"t": 0, "xyz": init_mocap_pose_right[:3], "quat": init_mocap_pose_right[3:], "gripper": 80}, # sleep
        ...
        elif config['task_name'] == 'sim_pick_the_right_green_block':
            gripper_pick_quat = Quaternion(init_mocap_pose_right[3:])
            gripper_pick_quat = gripper_pick_quat * Quaternion(axis=[.0, 1.0, .0], degrees=180)
            self.right_trajectory = [
                {"t": 0, "xyz": init_mocap_pose_right[:3], "quat": init_mocap_pose_right[3:], "gripper": 80}, # sleep
        ...
        elif config['task_name'] == 'sim_pick_the_left_red_block':
            gripper_pick_quat = Quaternion(init_mocap_pose_right[3:])
            gripper_pick_quat = gripper_pick_quat * Quaternion(axis=[.0, 1.0, .0], degrees=180)
            self.right_trajectory = [
        ...
        elif config['task_name'] == 'sim_pick_the_left_yellow_block':
            gripper_pick_quat = Quaternion(init_mocap_pose_right[3:])
            gripper_pick_quat = gripper_pick_quat * Quaternion(axis=[.0, 1.0, .0], degrees=180)
            self.right_trajectory = [
                {"t": 0, "xyz": init_mocap_pose_right[:3], "quat": init_mocap_pose_right[3:], "gripper": 0}, # sleep
        ...
        elif config['task_name'] == 'sim_pick_the_left_blue_block':
            gripper_pick_quat = Quaternion(init_mocap_pose_right[3:])
            gripper_pick_quat = gripper_pick_quat * Quaternion(axis=[.0, 1.0, .0], degrees=180)
            self.right_trajectory = [
            {"t": 0, "xyz": init_mocap_pose_right[:3], "quat": init_mocap_pose_right[3:], "gripper": 0}, # sleep
        ...
        elif config['task_name'] == 'sim_pick_the_left_green_block':
            gripper_pick_quat = Quaternion(init_mocap_pose_right[3:])
            gripper_pick_quat = gripper_pick_quat * Quaternion(axis=[.0, 1.0, .0], degrees=180)
            self.right_trajectory = [
                {"t": 0, "xyz": init_mocap_pose_right[:3], "quat": init_mocap_pose_right[3:], "gripper": 0}, # sleep
