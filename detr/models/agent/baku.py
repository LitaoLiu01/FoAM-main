...
import utils
from .networks.rgb_modules import BaseEncoder, ResnetEncoder
from .networks.policy_head import DeterministicHead, GMMHead, BeTHead, VQBeTHead, DiffusionHead
from .networks.gpt import GPT, GPTConfig
from .networks.mlp import MLP
from .networks.kmeans_discretizer import KMeansDiscretizer
...
class BCAgent:
    ...
    def update(self, expert_replay_iter, step, update=True):
        ...
        batch = next(expert_replay_iter)  # 在这里报错了
